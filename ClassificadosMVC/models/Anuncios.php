<?php
    ...
    class Anuncios extends Model {
        ...
        public function getTotalAnuncios($friltos) {
            ...
            $sql = $this->db->prepare("SELECT COUNT(*) as c FROM anuncios WHERE ".implode(' AND ', $friltostring));
        ...
        public function getUltimosAnuncios($page, $perPage, $friltos) {
            ...
            $sql = $this->db->prepare("SELECT *, (select anuncios_imagens.url from anuncios_imagens where anuncios_imagens.id_anuncio = anuncios.id limit 1) AS url,
