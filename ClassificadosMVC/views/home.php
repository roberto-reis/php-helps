            ...
            <div class="col-sm-9">
                        ...
                        <tr>
                            <td>
                                <?php if(!empty($anuncio['url'])): ?>
                                    <img src="<?php echo BASE_URL; ?>assets/images/anuncios/<?php echo $anuncio['url']; ?>" height="70" border="0">
                                <?php else: ?>
                                    <img src="<?php echo BASE_URL; ?>assets/images/anuncios/default.jpg" height="70" border="0">
                                <?php endif; ?>
                            </td>
                            <td>
                ...
                <ul class="pagination">
                    <?php for($q = 1; $q <= $total_paginas; $q++): ?>
                        <li class="page-item <?php echo ($page==$q) ? 'active' : ''; ?>"><a href="<?php echo BASE_URL; ?>?<?php                            
                            $w = $_GET;
                            $w['p'] = $q;
