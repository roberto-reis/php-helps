...
@section('content_header')
    <div class="row">
        ...
        <div class="col-md-6">
            <form method="GET">
                <select name="interval" onchange="this.form.submit()" id="" class="float-md-right">
                    ...
                    <option {{ $dateInterval == 120 ? 'selected="selected"' : '' }} value="180">Últimos 6 meses</option>
                </select>
            </form>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Pagínas Mais Visitadas</h3>
                </div>
                <div class="card-body">
